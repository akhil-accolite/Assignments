...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`custID`),
  KEY `lID` (`lID`),
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`lID`) REFERENCES `location` (`lid`)
...
INSERT INTO `customer` VALUES ('1','akhil','akhil.com','1'),('2','devansh','dev.com','1'),('3','divyaksh','div.com','3');
...
-- Dump completed on 2019-01-11 14:12:51
